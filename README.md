...
- [The Assignment Story](#the-assignment-story)
- [Prerequisite](#prerequisite)
      + [Prepare your Codespace for development](#prepare-your-codespace-for-development)
         - [Install AWS CLI](#install-aws-cli)
         - [Set your Credentials](#set-your-credentials)
         - [Install AWS CDK ](#install-aws-cdk)
      + [Bootstrap your account for CDK](#bootstrap-your-account-for-cdk)
      + [Deploy the Base Stack](#deploy-the-base-stack)
- [What we have till now](#what-we-have-till-now)
   * [Project Structure](#project-structure)
      + [CDK Files Structure](#cdk-files-structure)
      + [Service Files Structure](#service-files-structure)
   * [Understaning the API](#understaning-the-api)
      + [Restaurants API Endpoints](#restaurants-api-endpoints)
         - [Get API Configuration](#get-api-configuration)
            * [GET /](#get-)
         - [Add a New Restaurant](#add-a-new-restaurant)
            * [POST /restaurants](#post-restaurants)
         - [Get a Restaurant by Name](#get-a-restaurant-by-name)
            * [GET /restaurants/:restaurantName](#get-restaurantsrestaurantname)
         - [Delete a Restaurant by Name](#delete-a-restaurant-by-name)
            * [DELETE /restaurants/:restaurantName](#delete-restaurantsrestaurantname)
         - [Add a Rating to a Restaurant](#add-a-rating-to-a-restaurant)
            * [POST /restaurants/rating](#post-restaurantsrating)
         - [Get Top Rated Restaurants by Cuisine](#get-top-rated-restaurants-by-cuisine)
            * [GET /restaurants/cuisine/:cuisine](#get-restaurantscuisinecuisine)
         - [Get Top Rated Restaurants by Region](#get-top-rated-restaurants-by-region)
            * [GET /restaurants/region/:region](#get-restaurantsregionregion)
         - [Get Top Rated Restaurants by Region and Cuisine](#get-top-rated-restaurants-by-region-and-cuisine)
            * [GET /restaurants/region/:region/cuisine/:cuisine](#get-restaurantsregionregioncuisinecuisine)
      + [Run The tests](#run-the-tests)
   * [Tasks](#tasks)
      + [Implement the API with DynamoDB](#implement-the-api-with-dynamodb)
         - [10 points bonus](#10-points-bonus)
         - [Good to know ](#good-to-know)
         - [Run the tests ](#run-the-tests-1)
      + [Add Cache to Your Application](#add-cache-to-your-application)
      + [Implement External (Integration) Tests for the App](#implement-external-integration-tests-for-the-app)
- [Good luck! ](#good-luck)
